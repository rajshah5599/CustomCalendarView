package com.rajshah5599.customcalendarview;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HomeCollection.date_collection_arr.add( new HomeCollection("2020-12-08" ,"Diwali","Holiday","this is holiday"));
        HomeCollection.date_collection_arr.add( new HomeCollection("2020-12-08" ,"Holi","Holiday","this is holiday"));
